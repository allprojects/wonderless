...
\TODO{GS: how is the filtering happening in practice? Is
'Serverless Framework' a github user?}
...
To eliminate inactive projects, we removed the repositories with a lifetime 
